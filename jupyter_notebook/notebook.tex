...
Diese werden nach Beendigung der Messung als JSON-Datei gespeichert. Um
...
\end{Verbatim}
    ...
    Die Inkonstanz wird in erster Linie durch Paketverluste bei der
Übertragung verursacht. Die meisten Algorithmen zur Signalverarbeitung,
wie beispielsweise Passfilter, benötigen jedoch ein Signal mit
konstanter Abtastrate. Das Signal wird deshalb zunächst auf eine fixe
Abtastrate von 100 Hz resampled.
...
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{def} \PY{n+nf}{resample}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{frequency}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{x\PYZus{}new} \PY{o}{=} \PY{p}{[}\PY{n}{period\PYZus{}length} \PY{o}{*} \PY{n}{i} 
                      \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{samples\PYZus{}amount}\PY{p}{)}
                      \PY{k}{if} \PY{n}{period\PYZus{}length} \PY{o}{*} \PY{n}{i} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}
...
Signal ein breites Spektrum an Frequenzen enthält.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{k}{def} \PY{n+nf}{fft}\PY{p}{(}\PY{n}{y}\PY{p}{,} \PY{n}{frequency}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    Im folgenden Diagramm kann man die Graphen des ungefilterten Signals
(rot) und des gefilterten Signals (blau) vergleichen. Außerdem kann
beobachtet werden, welche Auswirkung die Veränderung der Grenzfrequenzen
des Tief- und Hochpass-Filters auf das Signal hat.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
Tiefpass-Filters garantiert werden.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k}{def} \PY{n+nf}{detect\PYZus{}peaks}\PY{p}{(}\PY{n}{y}\PY{p}{)}\PY{p}{:}
